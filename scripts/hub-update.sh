...
usage() {
    ...
    echo "  --images      Build and push core images to GCR (frontend, backend, data-generator, event-processor, external-system, spark-etl-job, iceberg-browser, inference-sim, inference-client)"

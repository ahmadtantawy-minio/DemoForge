...
async def get_scenarios():
    return {
        "scenarios": [
            ...
            {
                "id": "minio-g4",
                "label": "G4 as MinIO Object Store",
                "subtitle": "S3-native G4 tier — strong object throughput",
                "g4_label": "MinIO S3 (G4 tier)",
                "g35_label": None,
                "accent": "warning",
                "expectations": {
                    "gpu_util": "58-68% inference",
                    "recompute": "Low–moderate",
                    "ttft": "70-240ms",
                },
            },
            {
                "id": "minio-full",
                "label": "MinIO G4 S3 + G3.5 CTX RDMA",
                "subtitle": "G4 Object Store + G3.5 NVMe-oF/RDMA",
                "g4_label": "MinIO S3",
                "g35_label": "MinIO RDMA (BlueField-4)",
                "accent": "success",
                "expectations": {
                    "gpu_util": "88-94% inference",
                    "recompute": "Minimal",
                    "ttft": "32-72ms",
                },
            },

...
- [x] **DemoPresentation component** — Per-demo **intro** and **outro** slide sequences with hand-drawn slide content (e.g. embedded Excalidraw scenes), stored on the demo instance. Deliver as an **isolated component** (not folded into the React Flow diagram save path or template walkthrough). **Completed.**
